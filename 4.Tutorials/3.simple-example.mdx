---
title: "Building your first model in Sustainly"
description: "This page introduces a quick start of Sustainly, by using a simple example of a single-use Paper cup, from the raw material extraction to the end-of-life disposal, what is the overall environmental impact of it from the whole life cycle."
---

# Overview

This chapter will guide you through building a foundational Life Cycle Assessment (LCA) model for **a single-use paper cup** within Sustainly.

Upon completion of this tutorial, you will be proficient in:

- **Constructing a simple LCA model powered by AI**, encompassing all stages from raw material extraction to end-of-life disposal.
