...
slug: "lca-guideline/units-in-lca"
published: "true"
keywords: ["functional unit", "declared unit", "LCA comparison", "sustainability metrics"]
---
...
<img
  ...
  alt="Life cycle assessment example comparing T-shirt production, showing that T-shirt A generates 20 kg CO2e while T-shirt B generates 10 kg CO2e."
  title="Example Shirts Pn"
  className="mx-auto"
  style={{ borderRadius:"12px",width:"100%" }}
/>

👉Comparison of CO2e emissions between T-shirt A (20 kg) and T-shirt B (10 kg) in production.
