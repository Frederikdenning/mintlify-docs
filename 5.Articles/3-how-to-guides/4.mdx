...
keywords:
  ...
  - ISO 14044 functional unit
---

Choosing the right **functional unit** is one of the most critical steps in any Life Cycle Assessment (LCA). It defines *what exactly you are assessing* and ensures that your results are both accurate and comparable.
...
4. **Ensure comparability** – When comparing alternatives, all must serve the *same functional purpose*.  
